...
### 问题分析
- [ ] 当前问题：过了0:00就看不见内容，因为按自然日查询
- [ ] 当前问题：定时任务在12:00删除数据，导致历史记录丢失
- [ ] 正确需求：时间范围应该是"前一天12:00到当天12:00"
- [ ] 正确需求：历史数据不应该被删除，应该永久保留

### 定时任务修改
- [ ] 移除 clearTodayData 中删除数据的逻辑
- [ ] 只保留创建新表单的逻辑
- [ ] 确保历史数据永久保存

### 汇总页面查询逻辑修改
- [ ] 修改查询时间从"00:00-23:59"改为"前一天12:00-当天12:00"
- [ ] 更新前端日期选择器的说明文字
- [ ] 调整页面标题显示逻辑
...
### 测试验证
- [ ] 测试12:00之前能看到前一天12:00到当天12:00的数据
- [ ] 测试12:00之后能看到当天12:00到第二天12:00的数据
- [ ] 测试历史数据不会被删除
- [ ] 测试个人空间显示所有历史记录
